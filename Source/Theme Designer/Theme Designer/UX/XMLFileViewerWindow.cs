...
namespace ThemeDesigner
{
    public class XMLFileViewerWindow : KryptonForm
    {
        ...
        private Krypton.Toolkit.Suite.Extended.Tool.Strip.Items.KryptonSlider ksZoomLevelSlider;
        private System.Windows.Forms.ToolStripStatusLabel tsslZoomLevel;
        ...
        private void ksZoomLevelSlider_ValueChanged(Krypton.Toolkit.Extended.Common.KryptonToolbarSlider sender, Krypton.Toolkit.Extended.Common.KryptonToolbarSlider.SliderEventArgs eventArgs)
        {
            ...
            tsslZoomLevel.Text = $"{ seEdit.Zoom }%";
        }
    }
}